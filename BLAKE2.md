...
For certain content (like huge videos) the direct streaming feature can be a nice benefit. It allows content to be streamed directly out of cloud storage without the need for any intermediate server step that glues the contents together.
